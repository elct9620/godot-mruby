...
## `RS-058` A node in the editor lists what its script declares as its reloaded file runs again

| Step | Statement |
| --- | --- |
| Given | a scene open in the editor whose node's script is a node script whose file has run there |
